...
IF(UNIX)  
  ...
  IF(CMAKE_COMPILER_IS_GNUCC)
    SET(COMMON_C_FLAGS               "-gdwarf-2 -g3 -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing")
    ...
    SET(CMAKE_C_FLAGS_RELWITHDEBINFO "-gdwarf-2 -g3 ${COMMON_C_FLAGS}")
  ENDIF()
  IF(CMAKE_COMPILER_IS_GNUCXX)
    SET(COMMON_CXX_FLAGS               "-gdwarf-2 -g3 -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing")
    ...
    SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-gdwarf-2 -g3 ${COMMON_CXX_FLAGS}")
  ENDIF()

  # Default Clang flags
  IF(CMAKE_C_COMPILER_ID MATCHES "Clang")
    SET(COMMON_C_FLAGS               "-gdwarf-2 -g3 -fno-omit-frame-pointer -fno-strict-aliasing")
    SET(CMAKE_C_FLAGS_DEBUG          "${COMMON_C_FLAGS}")
    SET(CMAKE_C_FLAGS_RELWITHDEBINFO "-gdwarf-2 -g3 ${COMMON_C_FLAGS}")
  ENDIF()
  IF(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    SET(COMMON_CXX_FLAGS               "-gdwarf-2 -g3 -fno-omit-frame-pointer -fno-strict-aliasing")
    SET(CMAKE_CXX_FLAGS_DEBUG          "${COMMON_CXX_FLAGS}")
    SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-gdwarf-2 -g3 ${COMMON_CXX_FLAGS}")
  ENDIF()
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
    ...
    IF(CMAKE_C_COMPILER_ID MATCHES "SunPro")
      ...
      SET(COMMON_C_FLAGS            "-gdwarf-2 -g3 ${SUNPRO_FLAGS}")
      SET(COMMON_CXX_FLAGS          "-gdwarf-2 -g3 ${SUNPRO_FLAGS}")
      SET(CMAKE_C_FLAGS_DEBUG       "${COMMON_C_FLAGS}")
      SET(CMAKE_CXX_FLAGS_DEBUG     "${COMMON_CXX_FLAGS}")
